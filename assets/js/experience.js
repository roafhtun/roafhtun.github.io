...
const exp = [
  ...
  },
  {
    ...
    cardImage: "assets/images/experience-page/aerospace.jpg",
    place: "The Aerospace Corporation",
    time: "(Sep, 2023 - May, 2024)",
    desp: "<li>Pioneered the development of a web application for real-time visualization of GPS performance data (DOP) over a world map, leveraging Python for backend development and D3.js for dynamic frontend visualization.</li><li>Engineered a robust backend system using Python to automate data fetching from various websites, data parsing, calculating DOP, GPS week, and seconds, and ensuring data integrity for storage in InfluxDB.</li><li>Spearheaded the frontend team's efforts to create an intuitive and interactive map using D3.js, enabling users to visualize DOP data effectively, and contributing to a 25% increase in analytical efficiency.</li><li>Facilitated the seamless integration of frontend and backend functionalities, ensuring efficient data flow and user-friendly application performance.</li>",
  },
  {
